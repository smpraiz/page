...
export const PRODUCTS = {
    ...
    'Principais': [
        // produtos
        {
            ...
            command: 'discord broadcast kit_bau',
            fields: [
                {
                    type: "text",
                    name: "player",
        ...
        },
        {
            ...
            command: 'discord broadcast unban_player',
            fields: [
                {
                    type: "text",
                    name: "player",
    ...
    'Gemas': [
        {
            ...
            command: 'discord broadcast gemas_100',
            fields: [
                {
                    type: "text",
                    name: "player",
        ...
        },
        {
            ...
            icon: 'https://minecraft.wiki/images/Emerald_JE3_BE3.png?4c5f3',
            command: 'discord broadcast gemas_500',
            fields: [
                {
                    type: "text",
                    name: "player",
        ...
        },
        {
            ...
            icon: 'https://minecraft.wiki/images/Emerald_JE3_BE3.png?4c5f3',
            command: 'discord broadcast gemas_1000',
            fields: [
                {
                    type: "text",
                    name: "player",
    ...
    'Cosméticos': [
        {
            ...
            command: 'discord broadcast cor_nick_basica',
            fields: [
                {
                    type: "text",
                    name: "player",
        ...
        },
        {
            ...
            command: 'discord broadcast cor_nick_premium',
            fields: [
                {
                    type: "text",
                    name: "player",
